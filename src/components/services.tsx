...
export default function Services() {
    return (
        ...
        <div className="relative py-16 mb-3">
        <div className="max-w-9xl mt-10 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-2">
            ...
            <ListItem>Custom Dashboards/ORM&rsquo;s/CRM&rsquo;s to Manage your busniess effortlessly</ListItem>
            ...
            <ListItem>Provide SRE support / Manage your Deployments</ListItem>
