    ...
    <div className="isolate bg-white py-24 px-6 sm:py-32 lg:px-8">
      ...
      <form onSubmit={handleSubmit} className="mx-auto mt-16 max-w-xl sm:mt-20">
        ...
        <div className="mt-10">
          ...
          {loading && (
          <div role="status">
            <svg aria-hidden="true" className="mt-5 w-8 h-8 mr-2 text-focus animate-spin dark:text-focus fill-primary" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
